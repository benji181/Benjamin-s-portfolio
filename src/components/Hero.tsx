                ...
                <div className="text-center space-y-6 sm:space-y-8 animate-fade-in">
                    ...
                    <div className="pt-2 sm:pt-4">
                        <a
                            ...
                            download
                            className="inline-flex items-center px-6 py-4 sm:px-8 sm:py-6 text-base sm:text-lg font-medium bg-gradient-primary hover:shadow-glow transition-all duration-300 rounded-lg"
                            target="_blank"
                    ...
                    <div className="flex justify-center gap-3 sm:gap-4 pt-6 sm:pt-8">
                        ...
                        >
                            <Button
                                variant="ghost"
                                size="icon"
                                className="h-10 w-10 sm:h-12 sm:w-12 hover:text-primary transition-colors"
                            >
